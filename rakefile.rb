...
flashplayer :run => "bin/TestProject-debug.swf"
...
flashplayer :test => "bin/TestProject-test.swf"

##############################
# SWC

compc "bin/TestProject.swc" do |t|
  t.input_class = "TestProject"
  t.static_link_runtime_shared_libraries = true
  t.source_path << 'src'
end

desc "Compile the SWC file"
task :swc => 'bin/TestProject.swc'
...
asdoc 'doc' do |t|
  t.doc_sources << "src"
  t.exclude_sources << "src/TestProjectRunner.as"
end
